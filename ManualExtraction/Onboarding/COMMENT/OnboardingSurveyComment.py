...
class OnboardingSurveyComment:
    ...
    def get_valid_file_path(self, file_description):
        while True:
            try:
                ...
                file_path = os.path.join('ManualExtraction', 'Onboarding', 'COMMENT', file_name)
    ...
    def run(self):
        ...
        updated_data.to_csv('OnboardingSurveyComment.csv', index=False)
        print("Data successfully updated and saved! 🎉")

# Running the OnboardingSurvey
survey = OnboardingSurveyComment()
survey.run()
