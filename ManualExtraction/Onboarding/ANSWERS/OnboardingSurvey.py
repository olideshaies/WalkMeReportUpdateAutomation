...
class OnboardingSurvey:
    ...
    def clean_data(self):
        ...
        colEasternDate = df.pop('QuestionDate&Time(Eastern)')
        df.insert(1, colEasternDate.name, colEasternDate)
    ...
    def append_new_data(self):
        ...
        if 'Id' in self.existing_data.columns:
    ...
    def fun_message(self):
        ...
        print("║        ╚═════╝  ╚═════╝     ╚═════╝  ╚═════╝     ╚═════╝  ╚═════╝    ║")
        print("║                                                                      ║")
        print("║    Welcome to the Onboarding Answers!                                ║")
    ...
    def get_valid_file_path(self, file_description):
        while True:
            try:
                ...
                file_path = os.path.join('ManualExtraction', 'Onboarding', 'ANSWERS', file_name)
    ...
    def run(self):
        ...
        updated_data.to_csv('OnboardingSurvey.csv', index=False)
